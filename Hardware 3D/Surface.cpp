...
Surface::Surface(UINT width, UINT height, std::unique_ptr<Color[]> pBuffer, bool alphaLoaded) noexcept
	: mWidth(width), mHeight(height), mAlphaLoaded(alphaLoaded), mBuffer(std::move(pBuffer))
{
}
